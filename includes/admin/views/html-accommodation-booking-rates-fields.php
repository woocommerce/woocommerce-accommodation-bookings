	...
	<td>
		<div class="select wc_booking_availability_type">
			<select name="wc_accommodation_booking_pricing_type[]">
				<option value="custom" <?php selected( $rate['type'], 'custom' ); ?>><?php _e( 'Custom date range', 'woocommerce-accommodation-bookings' ); ?></option>
				...
				<option value="days" <?php selected( $rate['type'], 'days' ); ?>><?php _e( 'Range of nights', 'woocommerce-accommodation-bookings' ); ?></option>
			</select>
		</div>
	</td>
	<td>
